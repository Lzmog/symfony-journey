...
class ProjectServiceContainer extends Container
{
    ...
    protected function getLoggerService()
    {
        ...
        $instance->debug('The logger just get started');
    ...
    {
        return $this->services['logger.stream_handler'] = new \Monolog\Handler\StreamHandler('/var/www/local-project/symfony-journey/dino_container/din.log');
    }
    ...
    {
        return array(
            'root_dir' => '/var/www/local-project/symfony-journey/dino_container',
            'logger_start_message' => 'The logger just get started',
        );
    }
}
